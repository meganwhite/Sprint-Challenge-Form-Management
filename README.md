...
- [ ] Why are forms used so often in web applications and software?
    Forms are so often used in web applications and software because they allow us to access input from users. Forms make web apps and software interactive and allow us to take in data to be used again.
...
- [ ] Why do we write tests for our apps?
    Testing minimizes the risk of bugs appearing in production code. It forces us to think about edge cases, surface bugs faster, and write better / more testable code.
